...
*/}}
{{- define "demo-api-guestbook.name" -}}
...
*/}}
{{- define "demo-api-guestbook.fullname" -}}
...
*/}}
{{- define "demo-api-guestbook.chart" -}}
...
*/}}
{{- define "demo-api-guestbook.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "demo-api-guestbook.fullname" .) .Values.serviceAccount.name }}
{{- else }}
